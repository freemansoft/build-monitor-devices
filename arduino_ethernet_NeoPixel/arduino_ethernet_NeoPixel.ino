...
#define BONJOUR_HOST_NAME "Arduino_NEO"
#define BONJOUR_SVC_NAME "Arduino_NEO._http"
...
void setup()
{
  ...
  /*
  EthernetBonjour.addServiceRecord(BONJOUR_SVC_NAME,
                                   80,
                                   MDNSServiceTCP);
  */
